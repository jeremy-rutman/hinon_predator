...
int servoMins[] =    {4600,5800,5700,5200,6000,5700,5900,4000,4000,4300,3700,3900};
int servoCenters[] = {5900,6100,6200,5700,7311,6277,6350,6300,6000,5900,5822,6000};
int servoMaxes[] =   {6600,6400,6700,6200,7312,7000,6800,7800,8000,7800,6500,8100};
...
int  hood(int command)
{
  ...
  if (command == OPEN)
  {
    //yinnon   change here - move_rel(servonum,start,finish,delay(ms))
      if(move_rel(servonum,0,100,30)) return 1 ;
  }
  else   //close
  {
    //and here
      if(move_rel(servonum,100,0,30)) return 1;
  }
}
...
//  delay(3000);
 // movie1();
move_rel(YAW,50,100,100);
delay(1000);
move_rel(YAW,100,0,100);
delay(1000);
move_rel(YAW,0,50,100);
delay(1000);
// showoff();
