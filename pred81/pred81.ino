...
//  Serial.print(" A5 ");Serial.println(analogRead(A5));
  ...
  if(analogRead(A1)>512) 
  {
    ...
    if (PAUSE_STATE == HIGH) PAUSE_STATE = LOW;
     ...
     Serial.print("pause button on, ps status ");Serial.println(PAUSE_STATE);
     Serial.flush();
